...
const LECTOR_GLYPHS = {
    ...
    // lucide "unfold-vertical" -- separación entre páginas ACTIVADA (páginas
    // "desplegadas" con espacio entre sí)
    spacingOn: `<path d="M12 22v-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M12 8V2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M4 12H2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M10 12H8" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M16 12h-2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M22 12h-2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="m15 19-3 3-3-3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="m15 5-3-3-3 3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
    // lucide "fold-vertical" -- separación entre páginas DESACTIVADA
    // (páginas "plegadas" una pegada a la otra)
    spacingOff: `<path d="M12 22v-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M12 8V2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M4 12H2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M10 12H8" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M16 12h-2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M22 12h-2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="m15 19-3-3-3 3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="m15 5-3 3-3-3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
};
