...
// blanco fijo) para poder reusarlos sueltos en cualquier lado -- ver
// GeneradorEscenas/ui.js, que reusa palette/clock/clapper fuera de una
// badge (bug real encontrado en vivo: con blanco fijo, esos glifos
// quedaban invisibles sobre fondo claro). Adentro de una badge de color
// sólido siguen viéndose blancos porque .tool-badge fija color:white en
// styles.css -- currentColor hereda eso ahí, y hereda lo que corresponda
// en cualquier otro lado.
const GLYPHS = {
    sync: `<path d="M4 12a8 8 0 0 1 13.66-5.66M20 12a8 8 0 0 1-13.66 5.66" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M17.5 3v4h-4M6.5 21v-4h4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
    music: `<circle cx="7" cy="18" r="3" fill="currentColor"/><circle cx="18" cy="16" r="3" fill="currentColor"/><path d="M10 18V5.5L21 4v11.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
    clock: `<circle cx="12" cy="12" r="8.5" stroke="currentColor" stroke-width="2" fill="none"/><path d="M12 7.5V12l3 2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
    note: `<path d="M6 3h9l4 4v14H6z" stroke="currentColor" stroke-width="2" stroke-linejoin="round" fill="none"/><path d="M14.5 3v4.5H19" stroke="currentColor" stroke-width="2" stroke-linejoin="round" fill="none"/><path d="M9 12.5h6M9 16h6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>`,
    money: `<rect x="3" y="7" width="18" height="12" rx="2.5" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="12" cy="13" r="2.6" stroke="currentColor" stroke-width="1.8" fill="none"/><path d="M3 10h3M18 16h3" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>`,
    palette: `<path d="M12 3.5a8.5 8 0 1 0 0 16c1.1 0 2-.82 2-1.9 0-.5-.2-.96-.53-1.3-.32-.35-.52-.8-.52-1.3 0-1.08.9-1.9 2-1.9H16.5c2.2 0 4-1.7 4-4C20.5 6 16.7 3.5 12 3.5Z" stroke="currentColor" stroke-width="1.8" fill="none"/><circle cx="7.3" cy="10.5" r="1.15" fill="currentColor"/><circle cx="9.8" cy="7" r="1.15" fill="currentColor"/><circle cx="14.7" cy="7" r="1.15" fill="currentColor"/><circle cx="17" cy="10.7" r="1.15" fill="currentColor"/>`,
    ...
    // NUEVO: set para Generador de Escenas -- esa herramienta es de antes
    // del pedido de "sin emoji" y quedó con pictogramas de colores sueltos
    // (🎥🕹️🎨🌸🕵️🩸🤖🌿🌀🏛️🔺🌾🎩☢️⚔️🚀🤠 para cada estética +
    // 🖌🕐📷💡📦🌧🎲✦💾 para tags/botones) -- se reemplazan acá por el
    // mismo estilo de trazo simple que el resto del set, sin tocar
    // engine.js (que es copia verbatim del escritorio, ver nota grande en
    // GeneradorEscenas/ui.js).
    dice: `<rect x="4" y="4" width="16" height="16" rx="3" stroke="currentColor" stroke-width="1.8" fill="none"/><circle cx="8" cy="8" r="1.3" fill="currentColor"/><circle cx="16" cy="8" r="1.3" fill="currentColor"/><circle cx="12" cy="12" r="1.3" fill="currentColor"/><circle cx="8" cy="16" r="1.3" fill="currentColor"/><circle cx="16" cy="16" r="1.3" fill="currentColor"/>`,
    gamepad: `<rect x="2.5" y="8" width="19" height="10" rx="5" stroke="currentColor" stroke-width="1.8" fill="none"/><path d="M7 11v4M5 13h4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><circle cx="15.5" cy="12" r="1" fill="currentColor"/><circle cx="18" cy="14.5" r="1" fill="currentColor"/>`,
    flower: `<circle cx="12" cy="12" r="2.2" fill="currentColor"/><circle cx="12" cy="6.5" r="2.6" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="17" cy="9.5" r="2.6" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="15" cy="16" r="2.6" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="9" cy="16" r="2.6" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="7" cy="9.5" r="2.6" stroke="currentColor" stroke-width="1.5" fill="none"/>`,
    hat: `<ellipse cx="12" cy="15.5" rx="9" ry="2.2" stroke="currentColor" stroke-width="1.6" fill="none"/><path d="M8 15.5V9.5a4 4 0 0 1 8 0v6" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" fill="none"/><path d="M8.3 10.5h7.4" stroke="currentColor" stroke-width="1.6"/>`,
    drop: `<path d="M12 3.5c3 4 6 7.6 6 11a6 6 0 1 1-12 0c0-3.4 3-7 6-11Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" fill="none"/>`,
    robot: `<rect x="5" y="9" width="14" height="11" rx="2.5" stroke="currentColor" stroke-width="1.8" fill="none"/><path d="M12 9V5.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><circle cx="12" cy="4.3" r="1.1" fill="currentColor"/><circle cx="9" cy="14" r="1.2" fill="currentColor"/><circle cx="15" cy="14" r="1.2" fill="currentColor"/><path d="M9 17.5h6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M2.5 12.5v3M21.5 12.5v3" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>`,
    leaf: `<path d="M5 19c0-8 4-14.5 14-14.5C19 14.5 12.5 19 5 19Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" fill="none"/><path d="M5 19c3-3 6.5-6.5 9-11" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>`,
    swirl: `<path d="M12 12a4 4 0 1 1 4-4c0 3-2.5 5.5-5.5 5.5A6.5 6.5 0 1 1 17 7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" fill="none"/>`,
    columns: `<path d="M4 20h16M4 4h16" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M6.5 4v16M12 4v16M17.5 4v16" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>`,
    triangle: `<path d="M12 3.5 21 19.5H3Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" fill="none"/><circle cx="12" cy="14.5" r="1.6" fill="currentColor"/>`,
    wheat: `<path d="M12 21V8" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M12 8 9 5.5M12 8l3-2.5M12 11l-3-2.2M12 11l3-2.2M12 14l-3-2M12 14l3-2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>`,
    tophat: `<rect x="7.5" y="3.5" width="9" height="9" rx="1" stroke="currentColor" stroke-width="1.8" fill="none"/><ellipse cx="12" cy="17.5" rx="9" ry="2.3" stroke="currentColor" stroke-width="1.8" fill="none"/><path d="M7.5 12.5h9" stroke="currentColor" stroke-width="1.6"/>`,
    radiation: `<circle cx="12" cy="12" r="2.2" fill="currentColor"/><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.6" fill="none"/><path d="M12 6v3.3M16.7 14.5l-2.9-1.7M7.3 14.5l2.9-1.7" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>`,
    sword: `<path d="M5 19 18 6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M14.5 9.5l3-3M9.5 14.5l3-3" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><circle cx="5" cy="19" r="1.3" fill="currentColor"/>`,
    rocket: `<path d="M12 2.5c3 2.5 4.5 6 4.5 10 0 2-.6 3.7-1.3 5H8.8c-.7-1.3-1.3-3-1.3-5 0-4 1.5-7.5 4.5-10Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" fill="none"/><circle cx="12" cy="10" r="1.8" stroke="currentColor" stroke-width="1.6" fill="none"/><path d="M8.8 17.5 6.5 21M15.2 17.5l2.3 3.5M10.3 17.5v3M13.7 17.5v3" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>`,
    cowboyhat: `<path d="M2.5 15.5c3-1.2 6-1.8 9.5-1.8s6.5.6 9.5 1.8c-1 1.5-3 1.7-4.3 1.2-1.7 1-3.4 1.4-5.2 1.4s-3.5-.4-5.2-1.4c-1.3.5-3.3.3-4.3-1.2Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" fill="none"/><path d="M8 13.7c0-3.3 1.6-6.2 4-6.2s4 2.9 4 6.2" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round" fill="none"/>`,
    bulb: `<path d="M9 17.5h6M9.5 20h5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/><path d="M12 3.5a6 6 0 0 0-3.3 11c.6.4 1 1.1 1 1.9v.6h4.6v-.6c0-.8.4-1.5 1-1.9a6 6 0 0 0-3.3-11Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" fill="none"/>`,
    box: `<path d="M3.5 8.5 12 4l8.5 4.5L12 13z" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round" fill="none"/><path d="M3.5 8.5V16l8.5 4.5V13M20.5 8.5V16L12 20.5" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round" fill="none"/>`,
    bookmark: `<path d="M6.5 3.5h11a1 1 0 0 1 1 1v16l-6.5-4-6.5 4v-16a1 1 0 0 1 1-1Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" fill="none"/>`,
